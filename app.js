...
function App() {
    ...
    const handleSave = () => {
        ...
        // Automatsko dodavanje u CRM ako klijent ne postoji
        if (!clients.find(c => c.name.toLowerCase() === newEntry.client.toLowerCase())) {
            const newClient = { 
                name: newEntry.client, 
                phone: newEntry.phone, 
                social: newEntry.social, 
                id: Date.now() 
            };
            setClients([...clients, newClient]);
        }
        
        setAppointments([...appointments, { ...newEntry, id: Date.now() + 1 }]);
        ...
        <div className="min-h-screen pb-32">
            ...
            <main className="p-4">
                ...
                {activeTab === 'biz' && (
                    ...
                    <div className="card-bg p-10 text-center gold-text font-black uppercase">Loading Stats...</div>
                )}
                    ...
                    <div className="card-bg w-full max-w-lg p-8 rounded-b-none border-t border-slate-700 shadow-2xl" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="pt-8 space-y-4 text-center">
                                <button onClick={handleSave} className="w-full gold-bg text-black font-black p-5 rounded-2xl uppercase tracking-widest active:scale-95 transition-all shadow-xl">Save Appointment</button>
